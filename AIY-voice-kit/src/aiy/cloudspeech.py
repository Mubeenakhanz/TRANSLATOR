...
END_OF_SINGLE_UTTERANCE = speech_v1p1beta1.types.StreamingRecognizeResponse.END_OF_SINGLE_UTTERANCE
...
class CloudSpeechClient:
    ...
    def _make_config(self, language_code, alternative_language_codes, hint_phrases):
        return speech_v1p1beta1.types.RecognitionConfig(
            encoding=speech_v1p1beta1.types.RecognitionConfig.LINEAR16,
    ...
    def recognize_bytes(self, data, language_code='en-US', alternative_language_codes = [], hint_phrases=None):
        """
        ...
        streaming_config=speech_v1p1beta1.types.StreamingRecognitionConfig(
            config=self._make_config(language_code, alternative_language_codes, hint_phrases),
            single_utterance=True)
        responses = self._client.streaming_recognize(
            config=streaming_config,
            requests=[speech_v1p1beta1.types.StreamingRecognizeRequest(audio_content=data)])
    ...
    def recognize(self, language_code='en-US', alternative_language_codes=None, hint_phrases=None):
        """
        ...
        with Recorder() as recorder:
            ...
            requests = (speech_v1p1beta1.types.StreamingRecognizeRequest(audio_content=data) for data in chunks)
